...
$snapsURL='http://'.$host .'/'/*.'/zx/' */.$snapPATH; //for WEB
...
<?php $d='ROMSMINE'; foreach(array_filter(iterator_to_array(new RecursiveIteratorIterator(new RecursiveDirectoryIterator($d)), false), fn($f) => in_array(strtolower($f->getExtension()), ['gif','z80','sna','scr'])) as $f) echo $f->getPathname()."\n<BR>"; ?>	bbbbbbbbbbbbbbbbbbbbbbbbbb
</body>
</html>
