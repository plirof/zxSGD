...
$snapsURL=''.'../'/*.'/zx/' */.$snapPATH; //250910 relative path for QAOP for localhost
//$snapsURL=''.$host .'/'/*.'/zx/' */.$snapPATH; //for WEB
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    gameItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            imagePath = "" + mypath; // Create the image path (250910 relative path)
